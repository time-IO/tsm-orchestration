...
- External MQTT and HTTP ingest streams are automatically restored after a Bento restart ([Merge Request](https://codebase.helmholtz.cloud/ufz-tsm/tsm-orchestration/-/merge_requests/549))
