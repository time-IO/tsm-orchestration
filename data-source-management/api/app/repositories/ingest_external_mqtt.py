...
class IngestExternalMqttRepository:
    def __init__(self, session: Session):
        self.model = IngestExternalMqtt
    ...
    def create(
        ...
        try:
            extra_data["ingest_type"] = IngestType.EXTERNAL_MQTT
            ...
            ingest_external_mqtt = IngestExternalMqtt.model_validate(
    ...
    def to_flat(self, entity: IngestExternalMqtt) -> IngestExternalMqttRead:
        ing = entity.ingest
        permission_group = ing.permission_group

        parser = ing.parser

        return IngestExternalMqttRead(
            # Ingest
            id=ing.id,
            uuid=ing.uuid,
            ...
            # external_mqtt
            external_mqtt_address=entity.external_mqtt_address,
            external_mqtt_port=entity.external_mqtt_port,
            external_mqtt_username=entity.external_mqtt_username,
            external_mqtt_password=entity.external_mqtt_password,
            external_mqtt_ca_cert=entity.external_mqtt_ca_cert,
            external_mqtt_client_cert=entity.external_mqtt_client_cert,
