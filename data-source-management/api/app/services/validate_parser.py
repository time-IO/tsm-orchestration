...
def validate_csv_parser(settings: ParserCsvUpdate, raw_data: str) -> ParserValidationResponse:
    logger.debug(
        "Validating parser"
    )
    ...
    csv_settings = {
        ...
        "timestamp_columns": [{"column": x.column, "format": x.timestamp_format} for x in settings.timestamp_columns],
