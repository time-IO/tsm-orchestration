<template>
  <qc-function-form-template function-title="flagGeneric" v-model:label="label" @submit="submitForm" @remove="removeForm">
    <!-- field        -->
    <div class="q-mb-md">
    ...
    <div class="q-mb-md">
      ...
      <span class="text-caption text-grey block">
        ...
        provided as pandas.Series. The function must return a boolean Series, where True indicates
