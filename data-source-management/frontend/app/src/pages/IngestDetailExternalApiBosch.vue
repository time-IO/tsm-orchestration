              ...
              <q-list>
                ...
                <q-item>
                  <q-item-section>
                    ...
                    <q-item-label caption>{{ item.endpoint }}</q-item-label>
                  </q-item-section>
                </q-item>

                <q-item>
                  <q-item-section>
                    <q-item-label>Sensor-ID</q-item-label>
                    <q-item-label caption>{{ item.sensor_id }}</q-item-label>
                  </q-item-section>
                </q-item>
                ...
                <q-item>
                  <q-item-section>
                    ...
                    <q-item-label caption>{{ item.bosch_username }}</q-item-label>
                  </q-item-section>
                </q-item>
...
const store = useIngestExternalApiBoschStore();

const item = ref<IngestExternalApiBoschPublic | null>(null);
