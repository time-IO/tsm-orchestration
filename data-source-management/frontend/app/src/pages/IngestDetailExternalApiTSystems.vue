              ...
              <q-list>
                ...
                <q-item>
                  <q-item-section>
                    ...
                    <q-item-label caption>{{ item.tsystems_username }}</q-item-label>
                  </q-item-section>
                </q-item>
                ...
                <q-item>
                  <q-item-section>
                    ...
                    <q-item-label caption>
                      <q-input
                        borderless
                        v-model="item.tsystems_password"
...
const item = ref<IngestExternalApiTSystemsPublic | null>(null);
...
const basePath = '/ingest/external-api/tsystems/';
