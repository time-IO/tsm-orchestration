...
export function createParserApiService<TPublic extends ParserPayloadPublic, TCreate extends ParserPayloadCreate, TUpdate extends ParserPayloadUpdate, TParse>(apiPath: string) {
