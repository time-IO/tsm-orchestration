SET search_path TO ${configdb_user};
...
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA ${configdb_user} TO ${configdb_user};
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA ${configdb_user} TO ${configdb_user};