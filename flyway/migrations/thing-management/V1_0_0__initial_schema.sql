...
(
    ...
    "authorization_provider_id" VARCHAR(255) UNIQUE,
...
(
    ...
    "enable_raw_data_storage" BOOLEAN                  NOT NULL,
    "created_at"       TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT NOW(),
    "created_by"       BIGINT                   NOT NULL
...
ALTER TABLE "thing"
    ADD CONSTRAINT "fk_thing_user" FOREIGN KEY ("created_by") REFERENCES "user" ("id") DEFERRABLE INITIALLY DEFERRED;
...
CREATE TABLE "external_api_type"
(
    "id"   BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    "name" VARCHAR(200) UNIQUE NOT NULL
);

CREATE TABLE external_api_ingest
(
    "id"            BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    "thing_id"      BIGINT UNIQUE NOT NULL,
    ...
    "settings"      jsonb         NULL,
    "name"          VARCHAR(200)  NOT NULL DEFAULT 'Unnamed API Ingest'
);

ALTER TABLE external_api_ingest
    ADD CONSTRAINT "fk_external_api_external_api_type" FOREIGN KEY ("api_type_id") REFERENCES "external_api_type" ("id") DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE external_api_ingest
    ADD CONSTRAINT "fk_external_api_thing" FOREIGN KEY ("thing_id") REFERENCES "thing" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

CREATE TABLE external_sftp_ingest
(
    "id"            BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    "thing_id"      BIGINT UNIQUE NOT NULL,
    ...
    "sync_interval" INT           NOT NULL,
    "sync_enabled"  boolean       NOT NULL,
    "name"          VARCHAR(200)  NOT NULL DEFAULT 'Unnamed SFTP Ingest',
    "file_name_pattern" VARCHAR(200) NULL,
    file_parser_id  BIGINT
);

ALTER TABLE external_sftp_ingest
    ADD CONSTRAINT "fk_external_sftp_thing" FOREIGN KEY ("thing_id") REFERENCES "thing" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;
