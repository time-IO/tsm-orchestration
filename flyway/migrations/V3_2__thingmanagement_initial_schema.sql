...
ALTER TABLE "rawdatastorage"
    ADD CONSTRAINT "fk_rawdatastorage_file_parser" FOREIGN KEY ("file_parser_id") REFERENCES "file_parser" ("id") DEFERRABLE INITIALLY DEFERRED;
...
(
    ...
    "project_id"        BIGINT         NOT NULL,
    "ingest_type_id"    BIGINT,
    "rawdatastorage_id" BIGINT UNIQUE,
    "mqtt_id"           BIGINT UNIQUE,
...
ALTER TABLE "thing"
    ADD CONSTRAINT "fk_thing_rawdatastorage" FOREIGN KEY ("rawdatastorage_id") REFERENCES "rawdatastorage" ("id") DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE "thing"
