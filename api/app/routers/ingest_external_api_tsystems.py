...
from ..models.ingest_external_api_tsystems import IngestExternalApiTSystemsCreate,IngestExternalApiTSystems,IngestExternalApiTSystemsUpdate,IngestExternalApiTSystemsPublic
...
def create(*, session: Session = Depends(get_session), payload: IngestExternalApiTSystemsCreate):
