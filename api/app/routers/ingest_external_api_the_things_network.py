...
from ..models.ingest_external_api_the_things_network import IngestExternalApiTheThingsNetworkCreate,IngestExternalApiTheThingsNetwork,IngestExternalApiTheThingsNetworkUpdate,IngestExternalApiTheThingsNetworkPublic
...
def create(*, session: Session = Depends(get_session), payload: IngestExternalApiTheThingsNetworkCreate):
