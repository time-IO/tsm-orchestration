...
#             targets=[
#                 StreamInfo(
#                     key="target", alias="T1S33", sta_thing_id=1, sta_stream_id=33
#                 )
#             ],
...
#                 fields=[
#                     StreamInfo(
#                         key="field", alias="T1S33", sta_thing_id=1, sta_stream_id=33
#                     )
#                 ],
#                 targets=[
#                     StreamInfo(
...
#     fields = load_streams(local_database, fields)
#     data = load_stream_data(local_database, streams=fields)
...
#         StreamInfo(key="field", alias="T2S44", sta_thing_id=4, sta_stream_id=44),
#         StreamInfo(key="field", alias="T2S46", sta_thing_id=4, sta_stream_id=46),
#         StreamInfo(key="target", alias="NEW", sta_thing_id=1, sta_stream_id=None),
#     ]
#     func = QcFunction(
#         "",
#         func_name="processGeneric",
...
#     fields = load_streams(local_database, streams=fields)
#     data = load_stream_data(local_database, streams=fields)

#     qc = SaQCWrapper(data)

#     qc.execute(func)
#     write_qc_data(conn=local_database, dbapi=local_dbapi, qc=qc)
