...
export const useIngestExternalApiNeutronMonitorStore = defineStore('ingestExternalApiNeutronMonitorStore', {
  ...
  actions: {
    async dispatchGetList() {
      const response = await API.ingestExternalApiNeutronMonitor.getList()
      this.ingestExternalApiNeutronMonitorList = response.data
    },
    ...
    async dispatchCreate(payload: IngestExternalApiNeutronMonitorCreate): Promise<IngestExternalApiNeutronMonitorPublic> {
      const response = await API.ingestExternalApiNeutronMonitor.create(payload)
      return response.data
    },
    async dispatchUpdate(id: number, payload: IngestExternalApiNeutronMonitorUpdate): Promise<IngestExternalApiNeutronMonitorPublic> {
