...
export const useIngestExternalApiTheThingsNetworkStore = defineStore('ingestExternalApiTheThingsNetworkStore', {
  ...
  actions: {
    async dispatchGetList() {
      const response = await API.ingestExternalApiTheThingsNetwork.getList()
      this.ingestExternalApiTheThingsNetworkList = response.data
    },
    ...
    async dispatchCreate(payload: IngestExternalApiTheThingsNetworkCreate): Promise<IngestExternalApiTheThingsNetworkPublic> {
      const response = await API.ingestExternalApiTheThingsNetwork.create(payload)
      return response.data
    },
    async dispatchUpdate(id: number, payload: IngestExternalApiTheThingsNetworkUpdate): Promise<IngestExternalApiTheThingsNetworkPublic> {
