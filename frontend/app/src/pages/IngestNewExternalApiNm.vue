    ...
    <q-card class="q-mb-lg" flat>
      <q-card-section>
        <q-form @submit.prevent="save" class="q-gutter-md">
          ...
          <q-select outlined class="q-mb-md" v-model="formData.time_resolution_in_minutes"
          ...
          <q-card-section class="q-pa-none">
            ...
            <div class="q-mt-md">
              <q-input
                ...
                :label="formData.sync_enabled?'Sync Interval (in minutes) *':'Sync Interval (in minutes)'"
                type="number"
                :rules="[val => !formData.sync_enabled || (val !== null && val !== '' && val > 0) || 'Interval must be a positive number when sync is enabled']"
              />
            </div>
          </q-card-section>
...
async function save() {
  ...
  const data: IngestExternalApiNeutronMonitorCreate = {
    ...
    time_resolution_in_minutes: formData.value.time_resolution_in_minutes === -1 ? null : formData.value.time_resolution_in_minutes,
  }
