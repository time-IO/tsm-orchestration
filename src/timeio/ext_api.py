...
class SyncNmApi:
    ...
    def parse(self, thing: Thing, content: MqttPayload.SyncExtApi):
        ...
        parsed_observations = self.parse_nm_response(nm_response, station_id, resolution)
        return parsed_observations
    ...
    def parse_nm_response(self, resp, station, resolution) -> dict:
        bodies = []
        header = {"sensor_id": station, "resolution": resolution, "nm_api_url": self.nm_base_url}
